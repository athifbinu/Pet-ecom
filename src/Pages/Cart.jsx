    ...
    >
      ...
      <div className="flex w-full sm:w-2/5 gap-4 items-center sm:items-start">
        ...
        <div className="flex flex-col justify-center h-full gap-2">
          <span className="font-bold text-gray-900 text-base sm:text-lg line-clamp-2">
            {item.productName}
          </span>
          <span className="text-sm font-semibold text-blue-600 sm:hidden">
            ₹{item.price}
          </span>
        </div>
      </div>
...
const Cart = () => {
  ...
  useEffect(() => {
    // Update SEO meta tags for Cart page
    updatePageMeta(
      seoConfig.cart.title,
      seoConfig.cart.description,
      seoConfig.cart.keywords,
              ...
              {cartItems.length === 0 ? (
                ...
                >
                  ...
                  <p className="text-gray-500 mb-8 max-w-md">
                    ...
                    Browse our top categories and discover our best deals!
                  </p>
                  <Link to="/shop">
                    <motion.button
